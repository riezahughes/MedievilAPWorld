...
_all_items: List[MedievilItemData] = [
    ...
    ("Chaos Rune: The Sleeping Village", 122, MedievilItemCategory.RUNE, False),
    ("Chaos Rune: Pools of the Ancient Dead", 123, MedievilItemCategory.RUNE, False),
    ("Chaos Rune: The Asylum Grounds", 124, MedievilItemCategory.RUNE, False),
    ...
    ("Earth Rune: The Sleeping Village", 134, MedievilItemCategory.RUNE, False),
    ...
    ("Earth Rune: The Time Device", 138, MedievilItemCategory.RUNE, False),

    ("Moon Rune: The Hilltop Mausoleum", 139, MedievilItemCategory.RUNE, False),
    ("Moon Rune: Scarecrow Fields", 140, MedievilItemCategory.RUNE, False),
    ("Moon Rune: The Sleeping Village", 141, MedievilItemCategory.RUNE, False),
    ...
    ("Star Rune: Pumpkin Gorge", 150, MedievilItemCategory.RUNE, False),    
