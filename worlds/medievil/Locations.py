...
location_tables = {
    ...
    "Hall of Heroes": [ # HALL OF HEROES DROP USE AN ARRAY SO FOR NOW I'M PUTTING THEM ON DYNAMIC
        ...
        MedievilLocationData("Life Bottle: Hall of Heroes (Dirk Steadfast)","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
        MedievilLocationData("Equipment: Broadsword from Woden the Mighty - HH","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
        MedievilLocationData("Equipment: Magic Sword from Dirk Steadfast - HH","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
        MedievilLocationData("Equipment: Hammer from Stanyer Iron Hewer - HH","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
        MedievilLocationData("Equipment: Axe from Bloodmonath- HH","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
        MedievilLocationData("Equipment: Crossbow from Canny Tim - HH","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
        MedievilLocationData("Equipment: Longbow from Ravenhooves The Archer - HH","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
        MedievilLocationData("Equipment: Fire Longbow from Ravenhooves the Archer - HH","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
        MedievilLocationData("Equipment: Magic Longbow from Ravenhooves the Archer - HH","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
        MedievilLocationData("Equipment: Spear from Imanzi Shongama - HH","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
        MedievilLocationData("Equipment: Lightning from Megwynne Stormbinder - HH","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
        MedievilLocationData("Equipment: Gold Shield from Karl Sturngard - HH","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
        MedievilLocationData("Energy Vial: Imanzi Shongama 1 - HH","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
        MedievilLocationData("Energy Vial: Imanzi Shongama 2 - HH","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
        MedievilLocationData("Energy Vial: Megwynne Stormbinder 1 - HH","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
        MedievilLocationData("Energy Vial: Megwynne Stormbinder 2 - HH","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
        MedievilLocationData("Energy Vial: Megwynne Stormbinder 3 - HH","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
        MedievilLocationData("Gold Coins: Stanyer Iron Hewer 1 - HH","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
        MedievilLocationData("Gold Coins: Stanyer Iron Hewer 2 - HH","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
        MedievilLocationData("Gold Coins: Woden the Mighty 1 - HH","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
        MedievilLocationData("Gold Coins: Woden the Mighty 2 - HH","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
        MedievilLocationData("Gold Coins: Bloodmonath 1 - HH","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
        MedievilLocationData("Gold Coins: Bloodmonath 2 - HH","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
        MedievilLocationData("Gold Coins: Bloodmonath 3 - HH","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
        MedievilLocationData("Gold Coins: Karl Sturngard 1 - HH","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
        MedievilLocationData("Gold Coins: Karl Sturngard 2 - HH","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
        MedievilLocationData("Gold Coins: Karl Sturngard 3 - HH","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
        MedievilLocationData("Gold Coins: Karl Sturngard 4 - HH","Gold Shield Ammo (100)",MedievilLocationCategory.FUN),
    ],
